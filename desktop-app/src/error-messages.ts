...
const messages: Record<ErrorCode, string> = {
  ...
  AI_NOT_CONFIGURED: "请先在设置中完成 AI 服务配置。",
  AI_AUTH_FAILED: "AI 服务凭据验证失败，请检查后重新保存。",
  AI_NETWORK_ERROR: "暂时无法连接 AI 服务，请稍后重试。",
  AI_TIMEOUT: "AI 服务响应超时，请稍后重试。",
  AI_RATE_LIMITED: "AI 服务请求过于频繁，请稍后重试。",
  AI_SAFETY_BLOCKED: "这项内容无法继续整理。",
  AI_INPUT_TOO_LARGE: "内容过长，暂时无法整理。",
  AI_INVALID_OUTPUT: "整理结果无法使用，请重新整理。",
  ...
  DELIVERY_AMBIGUOUS: "发送结果暂时无法确认，请选择处理方式。",
  DELIVERY_FAILED_FINAL: "消息发送失败，请选择处理方式。",
  BACKUP_INVALID: "这个备份无法使用，请选择其他备份。",
  RESTORE_FAILED: "备份恢复未完成，请重新启动泡泡后重试。",
